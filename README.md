...
Proficiency Type | Known
---------------- | -----
Armor | Light and Medium
Save | Constitution and Intelligence
Skill | Arcana, plus two more from History, Intimidation, Medicine, Nature, Sleight of Hand
Tool | Alchemist's Supplies and two others.
Weapon | Simple

Equipment (Each line, in addition to background equipment) |
----------------- | 
Alchemist's Supplies |
Leather Armor |
Light Crossbow OR Shortbow OR 25 Spears |
...
## Concoctions
At 1st level, you learn two Alchemical Concoction options of your choice. You learn an additional concoction of your choice at 3rd, 9th, 14th, and 17th levels. To use any of these options, you must be within reach of a set of Alchemist's Supplies. If the concoction requires a saving throw, the DC is 8 + your proficiency bonus + your Intelligence modifier. You can always choose to make concoctions weaker than you might have otherwise, so a 17th level Alchemist can still choose to make a 1st level Phos-Popper.
